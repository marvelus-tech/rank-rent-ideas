# MarvelUs Lead Gen (Marvelus.cc + Nolostsales.cc)

> **Skill name:** MarvelUs-lead-gen (formerly MarvelUs-lead-gen)

Systematic lead generation + deduped daily operations for AI voice/chat agency outreach.

**Current Pipeline (Phases 1-5 complete):**
1. ✅ **Browser Scraper** — Google Maps with website extraction
2. ✅ **Contact Enricher** — Email, phone, socials from business websites
3. ✅ **Website Analyzer (Phase 1)** — Real SEO signals + seo_health_score (0-100)
4. ✅ **Multi-Dimensional Scorer (Phase 2)** — AI Voice / Web-SEO / Reputation / Booking + overall + is_multi_opportunity
5. ✅ **Full-Service Targeting (Phase 3)** — Category bias toward multi-opportunity leads
6. ✅ **Schema + Outputs (Phase 4)** — New fields in store, dashboard, reports
7. ✅ **Integration & Safety (Phase 5)** — Feature flags, tests, validation, graceful degradation
8. ✅ **Auto-Outreach (Phase 7)** — Personalized SMS + Email draft generation using full scoring intelligence (recommended service, multi-opportunity, SEO health)
